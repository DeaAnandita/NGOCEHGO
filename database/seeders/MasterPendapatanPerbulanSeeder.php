...
class MasterPendapatanPerbulanSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('master_pendapatanperbulan')->insert([
            ...
            ['kdpendapatanperbulan' => 2, 'pendapatanperbulan' => 'RP. 1 JUTA S/D RP. 1,5 JUTA'],
            ['kdpendapatanperbulan' => 3, 'pendapatanperbulan' => 'RP. 1,5 JUTA S/D RP. 2 JUTA'],
            ['kdpendapatanperbulan' => 4, 'pendapatanperbulan' => 'RP. 2 JUTA S/D RP. 3 JUTA'],
