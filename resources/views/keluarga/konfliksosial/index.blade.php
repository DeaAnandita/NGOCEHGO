            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
                    ...
                    <!-- Dropdown Export -->
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <a href="{{ route('export.konfliksosial') }}"
                                ...
                                <a href="{{ route('konfliksosial.export.pdf') }}"
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
                        ...
                        <!-- Dropdown Per Page -->
                        <form method="GET" action="{{ route('keluarga.konfliksosial.index') }}" class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                        ...
                        <!-- Form Search -->
                        <form method="GET" action="{{ route('keluarga.konfliksosial.index') }}" 
