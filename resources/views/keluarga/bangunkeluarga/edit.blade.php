    ...
    <div class="flex">
        ...
        <div class="flex-1 py-6 px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <h3 class="text-xl font-bold text-gray-800 mb-6">Edit Data Bangun Keluarga</h3>

                <form action="{{ route('keluarga.bangunkeluarga.update', $bangunkeluarga->no_kk) }}" method="POST">
                    @csrf
                    @method('PUT')
