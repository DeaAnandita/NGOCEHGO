            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
                    <div class="flex items-center gap-3 flex-wrap">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <a href="{{ route('export.asetkeluarga') }}"
                                ...
                                <a href="{{ route('asetkeluarga.exportAnalisisPDF') }}"
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
                        <!-- Dropdown Per Page -->
                        <form method="GET" action="{{ route('keluarga.asetkeluarga.index') }}" class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 text-gray-700">
                                @forelse($asetkeluargas as $aset)
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="border border-gray-200 px-4 py-3">{{ $asetkeluargas->firstItem() + $loop->index }}</td>
