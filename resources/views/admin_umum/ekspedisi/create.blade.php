    ...
    <div class="flex">
        ...
        <div class="flex-1 py-6 px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-6">Tambah Buku Ekspedisi</h3>
                ...
                <form id="formEkspedisi" method="POST" enctype="multipart/form-data"
                    action="{{ route('admin-umum.ekspedisi.store') }}">
                    @csrf
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="kdekspedisi" id="kode" value="{{ old('kdekspedisi') }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="ekspedisi_tanggal" value="{{ old('ekspedisi_tanggal') }}"
                                    class="w-full rounded-lg border-gray-300">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="ekspedisi_nomorsurat"
                                    value="{{ old('ekspedisi_nomorsurat') }}" class="w-full rounded-lg border-gray-300">
                            </div>

                            <div>
                                <label class="text-sm font-medium">Tanggal Surat</label>
                                <input type="date" name="ekspedisi_tanggalsurat"
                                    value="{{ old('ekspedisi_tanggalsurat') }}"
                                    class="w-full rounded-lg border-gray-300">
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="ekspedisi_identitassurat"
                                    value="{{ old('ekspedisi_identitassurat') }}"
                                    class="w-full rounded-lg border-gray-300">
                            </div>

                            <div class="sm:col-span-2">
                                <label class="text-sm font-medium">Isi Surat</label>
                                <textarea name="ekspedisi_isisurat" class="w-full rounded-lg border-gray-300">{{ old('ekspedisi_isisurat') }}</textarea>
                            </div>

                            <div class="sm:col-span-2">
                                <label class="text-sm font-medium">Keterangan</label>
                                <textarea name="ekspedisi_keterangan" class="w-full rounded-lg border-gray-300">{{ old('ekspedisi_keterangan') }}</textarea>
                            </div>
