            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                    ...
                    <div class="flex items-center gap-3 flex-wrap">
                        <h3 class="text-xl font-bold text-gray-800">Buku Peraturan Desa</h3>
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.away="open=false" x-transition
                                ...
                                <a href="{{ route('admin-umum.peraturan.export') }}"
                                    class="block px-4 py-2 text-sm hover:bg-gray-100">
                                    Export Excel
                                </a>
                                <a href="{{ route('admin-umum.peraturan.exportPdf') }}"
                                    class="block px-4 py-2 text-sm hover:bg-gray-100">
                                    Export PDF
                                </a>
                            </div>
                    ...
                    <div class="flex flex-wrap lg:flex-nowrap items-center gap-2 w-full lg:w-auto">
                        ...
                        <form method="GET" action="{{ route('admin-umum.peraturan.index') }}"
                        ...
                        <a href="{{ route('admin-umum.peraturan.create') }}"
                                ...
                                <tr class="border-t hover:bg-gray-50">
                                    ...
                                    <td>
                                        <div class="flex justify-center gap-2">
                                            ...
                                            {{-- DETAIL --}}
                                            <a href="{{ route('admin-umum.peraturan.show', $d->kdperaturan) }}"
                                            ...
                                            {{-- EDIT --}}
                                            <a href="{{ route('admin-umum.peraturan.edit', $d->kdperaturan) }}"
                                            ...
                                            {{-- DELETE --}}
                                            <form action="{{ route('admin-umum.peraturan.destroy', $d->kdperaturan) }}"
                                                method="POST" x-data
                                                @submit.prevent="$dispatch('open-delete-modal', {
                                                    form: $el,
                                                    name: '{{ $d->nomorperaturan }}'
                                                })">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="7" class="py-12 text-center text-gray-500">
                                        <div class="flex flex-col items-center space-y-2">
                                            <x-heroicon-o-book-open class="w-10 h-10 text-gray-400" />
                                            <p class="font-medium">Belum ada data peraturan</p>
                                            <p class="text-sm">Klik <b>+ Tambah</b> untuk menambah peraturan</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
