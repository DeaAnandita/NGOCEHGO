<x-app-layout>
        ...
        <div class="flex-1 py-6 px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <form id="formAparat" method="POST" enctype="multipart/form-data"
                    action="{{ route('admin-umum.aparat.store') }}">
                    @csrf
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <select name="kdaparat" id="kdaparat"
                                    ...
                                    @foreach ($masterAparat as $a)
                                        <option value="{{ $a->kdaparat }}"
                                            {{ old('kdaparat') == $a->kdaparat ? 'selected' : '' }}>
                                            {{ $a->aparat }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="namaaparat" id="namaaparat" value="{{ old('namaaparat') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="nipaparat" id="nipaparat" value="{{ old('nipaparat') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="pangkataparat" value="{{ old('pangkataparat') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="nomorpengangkatan" value="{{ old('nomorpengangkatan') }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggalpengangkatan"
                                    value="{{ old('tanggalpengangkatan') }}"
                            ...
                            <div>
                                ...
                                <select name="statusaparatdesa"
                                    class="w-full rounded-lg border-gray-300 @error('statusaparatdesa') border-red-500 @enderror">
                                    <option value="Aktif"
                                        {{ old('statusaparatdesa', 'Aktif') == 'Aktif' ? 'selected' : '' }}>
                                        Aktif
                                    </option>
                                    <option value="Nonaktif"
                                        {{ old('statusaparatdesa') == 'Nonaktif' ? 'selected' : '' }}>
                                        Nonaktif
                                    </option>
                                </select>
                                <p class="text-red-600 text-xs mt-1">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="keteranganaparatdesa"
                                    class="w-full rounded-lg border-gray-300 @error('keteranganaparatdesa') border-red-500 @enderror" rows="3">{{ old('keteranganaparatdesa') }}</textarea>
                                <p class="text-red-600 text-xs mt-1">
    ...
    <script>
        ...
        function validateClient() {
            ...
            // NIP boleh kosong, kalau diisi minimal 8 digit, max 18
            if (nip) {
            ...
            // File: validasi type/size kalau ada
            if (file) {
                let msg = "";
