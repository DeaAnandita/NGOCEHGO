            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                    ...
                    <div class="flex items-center gap-3 flex-wrap">
                        <h3 class="text-xl font-bold text-gray-800">Data Anggaran Kelembagaan</h3>
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.away="open=false" x-transition
                                ...
                                <a href="{{ route('kelembagaan.anggaran.export') }}"
                                    class="block px-4 py-2 text-sm hover:bg-gray-100">
                                    Export Excel
                                </a>
                                <a href="{{ route('kelembagaan.anggaran.exportPdf') }}"
                                    class="block px-4 py-2 text-sm hover:bg-gray-100">
                                    Export PDF
                                </a>
                            </div>
                    ...
                    <div class="flex flex-wrap lg:flex-nowrap items-center gap-2 w-full lg:w-auto">
                        ...
                        <form method="GET" action="{{ route('kelembagaan.anggaran.index') }}"
                        ...
                        <a href="{{ route('kelembagaan.anggaran.create') }}"
                        ...
                        <tbody class="text-center">
                            @forelse ($anggaran as $a)
                                <tr class="border-t hover:bg-gray-50">
                                    ...
                                    <td>{{ $a->periode->tahun_awal ?? '-' }}</td>

                                    <td class="text-right px-2 font-semibold">
                                        Rp {{ number_format($a->total_anggaran, 0, ',', '.') }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="flex justify-center gap-2">
                                            ...
                                            {{-- DETAIL --}}
                                            <a href="{{ route('kelembagaan.anggaran.show', $a->id) }}"
                                            ...
                                            {{-- EDIT --}}
                                            <a href="{{ route('kelembagaan.anggaran.edit', $a->id) }}"
                                            ...
                                            {{-- DELETE --}}
                                            <form action="{{ route('kelembagaan.anggaran.destroy', $a->id) }}"
                                                method="POST" x-data
                                                @submit.prevent="$dispatch('open-delete-modal', {
                                                    form: $el,
                                                    name: 'Anggaran {{ $a->unit->unit_keputusan ?? '' }}'
                                                })">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="5" class="py-12 text-center text-gray-500">
                                        <div class="flex flex-col items-center justify-center space-y-2">
                                            ...
                                            <p class="font-medium text-gray-600">Data anggaran belum ada</p>
                                            <p class="text-sm text-gray-400">
                                                Silakan klik tombol <b>+ Tambah</b> untuk menambahkan anggaran.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
