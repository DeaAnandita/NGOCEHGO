    ...
    <div class="flex">
        ...
        <div class="flex-1 py-6 px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <form action="{{ route('kelembagaan.agenda.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="uraian_agenda" rows="3" class="w-full rounded-lg border-gray-300">{{ old('uraian_agenda') }}</textarea>
                            </div>
                                ...
                                <select name="kdtempat" class="w-full rounded-lg border-gray-300" required>
                                    ...
                                    @foreach ($tempat as $t)
                                        <option value="{{ $t->kdtempat }}"
                                            {{ old('kdtempat') == $t->kdtempat ? 'selected' : '' }}>
                                            {{ $t->tempat_agenda }}
                                        </option>
                                    @endforeach
                                </select>
