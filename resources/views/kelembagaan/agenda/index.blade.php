            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                    ...
                    <div class="flex items-center gap-3 flex-wrap">
                        <h3 class="text-xl font-bold text-gray-800">Agenda Kelembagaan</h3>
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.away="open=false" x-transition
                                ...
                                <a href="{{ route('kelembagaan.agenda.export') }}"
                                    class="block px-4 py-2 text-sm hover:bg-gray-100">
                                    Export Excel
                                </a>
                                <a href="{{ route('kelembagaan.agenda.exportPdf') }}"
                                    class="block px-4 py-2 text-sm hover:bg-gray-100">
                                    Export PDF
                                </a>
                            </div>
                    ...
                    <div class="flex flex-wrap lg:flex-nowrap items-center gap-2 w-full lg:w-auto">
                        ...
                        <form method="GET" action="{{ route('kelembagaan.agenda.index') }}"
                        ...
                        <a href="{{ route('kelembagaan.agenda.create') }}"
                        ...
                        <tbody class="text-center">
                            @forelse ($agenda as $a)
                                <tr class="border-t hover:bg-gray-50">
                                    ...
                                    <td class="text-left font-medium px-2">
                                        {{ $a->judul_agenda }}
                                    </td>
                                    ...
                                    <td>
                                        <span
                                            ...
                                            {{ ($a->status->status_agenda ?? '') == 'Aktif' ? 'bg-green-600' : 'bg-gray-500' }}">
                                    ...
                                    <td>
                                        <div class="flex justify-center gap-2">
                                            ...
                                            {{-- DETAIL --}}
                                            <a href="{{ route('kelembagaan.agenda.show', $a->id) }}"
                                            ...
                                            {{-- EDIT --}}
                                            <a href="{{ route('kelembagaan.agenda.edit', $a->id) }}"
                                            ...
                                            {{-- DELETE --}}
                                            <form action="{{ route('kelembagaan.agenda.destroy', $a->id) }}"
                                                method="POST" x-data
                                ...
                                <tr>
                                    <td colspan="9" class="py-12 text-center text-gray-500">
                                        <div class="flex flex-col items-center space-y-2">
                                            ...
                                            <p class="font-medium">Belum ada agenda</p>
                                            <p class="text-sm">Klik <b>+ Tambah</b> untuk membuat agenda</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
