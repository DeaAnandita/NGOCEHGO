        ...
        <div class="relative bg-gradient-to-br from-blue-200 to-blue-100 
            ...
            <div class="relative z-10 max-w-2xl mx-auto text-center">
                ...
                <p class="opacity-90 mt-3 text-sm sm:text-base">
                    Lihat semua data keluarga dan penduduk — dari input <span class="font-medium text-blue-700">suara</span> atau <span class="font-medium text-blue-700">manual</span>.
                </p>
            </div>
        </div>
