<x-app-layout>
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div id="masterGrid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <x-master-card route="carapembuangansampah" color="blue" icon="🏠" title="Cara Pembuangan Sampah" desc="Kelola data cara pembuangan sampah" />
            ...
            <x-master-card route="jawabtempatpersalinan" color="blue" icon="🏠" title="Jawab Tempat Persalinan" desc="Kelola data jawab tempat persalinan" />
