<x-app-layout>
    <div class="flex">
        ...
        <div class="flex-1 py-6 px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-lg p-6">
                ...
                <h3 class="text-xl font-bold text-gray-800 mb-6">Tambah Buku Bantuan</h3>
                ...
                <form id="formBantuan" action="{{ route('admin-pembangunan.bantuan.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" id="nama" name="bantuan_nama" value="{{ old('bantuan_nama') }}"
                        ...
                        <div>
                            ...
                            <select id="sasaran" name="kdsasaran" class="w-full rounded-lg border-gray-300">
                                ...
                                @foreach ($sasaran as $s)
                                    <option value="{{ $s->kdsasaran }}">{{ $s->sasaran }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select id="jenis" name="kdbantuan" class="w-full rounded-lg border-gray-300">
                                ...
                                @foreach ($bantuan as $b)
                                    <option value="{{ $b->kdbantuan }}">{{ $b->bantuan }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="date" id="awal" name="bantuan_awal" value="{{ old('bantuan_awal') }}"
                                class="w-full rounded-lg border-gray-300">
                        ...
                        <div>
                            ...
                            <input type="date" id="akhir" name="bantuan_akhir"
                                value="{{ old('bantuan_akhir') }}" class="w-full rounded-lg border-gray-300">
    ...
    <script>
        ...
        function validate() {
            ...
            awalError.innerText = awal.value ? "" : "Tanggal awal wajib diisi";
